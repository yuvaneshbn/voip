...
public:
	Nox::Protocol::TCPMessageType type;
	QByteArray qbaMsg;
	bool bFlush;
	ServerHandlerMessageEvent(const QByteArray &msg, Nox::Protocol::TCPMessageType type, bool flush = false);
};
...
protected:
	...
	bool bStrong;
	int connectionID;
	Nox::Protocol::UDPPingEncoder< Nox::Protocol::Role::Client > m_udpPingEncoder;
	Nox::Protocol::UDPDecoder< Nox::Protocol::Role::Client > m_udpDecoder;
	Nox::Protocol::UDPDecoder< Nox::Protocol::Role::Client > m_tcpTunnelDecoder;
	...
	void handleVoicePacket(const Nox::Protocol::AudioData &audioData);
...
public:
	...
	void sendProtoMessage(const ::google::protobuf::Message &msg, Nox::Protocol::TCPMessageType type);
...
#define PROCESS_NOX_TCP_MESSAGE(name, value) \
	void sendMessage(const NoxProto::name &msg) { sendProtoMessage(msg, Nox::Protocol::TCPMessageType::name); }
