#ifndef THIRD_PARTY_SPEEXDSP_CONFIG_H_
#define THIRD_PARTY_SPEEXDSP_CONFIG_H_

/* Microsoft C compiler support for inline in C mode. */
...
#if (defined(_M_IX86_FP) && _M_IX86_FP >= 1) || defined(_M_X64)
#define USE_SSE
#endif
...
#endif  /* THIRD_PARTY_SPEEXDSP_CONFIG_H_ */
