#ifndef QT_FEATURES_Quick_src_quick_qtquick_config_p_h_H
#define QT_FEATURES_Quick_src_quick_qtquick_config_p_h_H
...
#endif // QT_FEATURES_Quick_src_quick_qtquick_config_p_h_H
