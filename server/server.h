...
#ifndef NOX_SERVER_H_
#define NOX_SERVER_H_
...
public:
	...
	Nox::Protocol::UDPDecoder< Nox::Protocol::Role::Server > m_udpDecoder;
	Nox::Protocol::UDPDecoder< Nox::Protocol::Role::Server > m_tcpTunnelDecoder;
	Nox::Protocol::UDPPingEncoder< Nox::Protocol::Role::Server > m_udpPingEncoder;
	Nox::Protocol::UDPAudioEncoder< Nox::Protocol::Role::Server > m_udpAudioEncoder;
	Nox::Protocol::UDPAudioEncoder< Nox::Protocol::Role::Server > m_tcpAudioEncoder;

	std::span< const Nox::Protocol::byte >
		handlePing(const Nox::Protocol::UDPDecoder< Nox::Protocol::Role::Server > &decoder,
					  Nox::Protocol::UDPPingEncoder< Nox::Protocol::Role::Server > &encoder, bool expectExtended);
